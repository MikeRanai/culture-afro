      ...
      {showForm && (
        <div className="mb-6 rounded-2xl border border-afro-dark/10 bg-white p-5 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-afro-dark/70">Logo (URL)</label>
              <input type="text" value={form.logo} onChange={(e) => setForm({ ...form, logo: e.target.value })} className="min-h-[44px] w-full rounded-xl border border-afro-dark/10 bg-afro-light px-4 text-base text-afro-dark transition-colors focus:border-afro-orange focus:outline-none focus:ring-1 focus:ring-afro-orange/30" placeholder="/images/partenaire-x.png" />
            </div>

...
const infos = [
  {
    icon: Phone,
    title: "Téléphone",
    value: "+262 692 25 90 07",
    href: "tel:+262692259007",
  },
  {
    icon: Mail,
    title: "Email",
    value: "contact@cultureafro.re",
              ...
              const Content = (
                <div className="flex items-start gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-afro-orange/10">
                    <info.icon
                      className="h-5 w-5 text-afro-orange"
                      aria-hidden="true"
                    />
                  </div>
                  <div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="min-h-[44px] w-full resize-none rounded-xl border border-afro-dark/10 bg-afro-light px-4 py-3 text-base text-afro-dark placeholder:text-afro-dark/35 transition-colors focus:border-afro-orange focus:outline-none focus:ring-1 focus:ring-afro-orange/30"
                />
              </div>
              ...
              <button
                type="submit"
                className="inline-flex min-h-[44px] items-center justify-center gap-2 self-start rounded-full bg-afro-magenta px-8 py-3 font-bold text-white shadow-lg shadow-afro-magenta/25 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-afro-magenta/30"
              >
                Envoyer
